                    ...
                    <Table sx={{ minWidth: 300 }} aria-label="candidate specs table">
                        ...
                        <TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>{props.reservation.spec.peeringCandidate.name}</TableCell>
                            </TableRow>
                        </TableBody>
                    </Table>
                </TableContainer>
                    ...
                    <Table sx={{ minWidth: 300 }} aria-label="partition table">
                        ...
                        <TableBody>
                            <TableRow> 
                                ...
                                <TableCell>{props.reservation.status.contract.name}</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell component="th" scope="row">Transaction ID </TableCell>
                                <TableCell>{props.reservation.status.transactionID}</TableCell>
                            </TableRow>
                            <TableRow>
