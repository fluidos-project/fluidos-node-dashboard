...
class Spec {
  constructor(data) {
    ...
    this.buyerClusterID = data.buyerClusterID || '';
    ...
    this.peeringTargetCredentials = new PeeringTargetCredentials(data.peeringTargetCredentials);
...
class Flavor {
  constructor(data) {
    this.metadata = new Metadata(data.metadata);
    this.spec = new FlavorSpec(data.spec);
    this.status = new FlavorStatus(data.status);
  }
}
